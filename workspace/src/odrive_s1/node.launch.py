...
def generate_launch_description():
    parameters = json.loads('{"joint":"693245c5013a1a6b43f3c4c9","control_mode":"position","limit.lower_position":0,"limit.upper_position":360,"limit.position_step":1,"limit.max_effort":10,"limit.effort_step":null,"limit.max_velocity":35,"limit.velocity_step":0}')
    ...
    env = {
        "POLYFLOW_NODE_ID": "693245cc013a1a6b43f3c4d6",
